...
public class ActitimeFetch {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='addTasksLink']/span[@class='dashedLink']")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[contains(.,'Big Bang Company')]/div[@class='dropdownButton']")).click();
		driver.findElement(By.xpath("//div[@id='closeCreateTasksPopupButton']")).click();
